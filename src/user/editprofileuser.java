 ...
 */
public class editprofileuser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, 130, 140));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       String gettype = usertype.getText();
       ...
       sess.setusername(getname);
       sess.setuseremail(getemail);
       sess.setuseraddress(getaddress);
       sess.setusertype(gettype);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editprofileuser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editprofileuser().setVisible(true);
            }
        });
    }
