 ...
 */
public class flighttable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 150, 690, 380));
        ...
        textsearchflight.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        textsearchflight.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                textsearchflightKeyReleased(evt);
            }
        });
        jPanel1.add(textsearchflight, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 100, 360, 30));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       int flightid = Integer.parseInt(jTable1.getValueAt(getflightid, 0).toString());
       String deleteairplane = "DELETE FROM table_flights WHERE flight_id = ?";
    ...
    private void textsearchflightKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textsearchflightKeyReleased
        config con = new config();
        String searchtextflight = textsearchflight.getText();
        String searchqueryflight = "SELECT * FROM table_flights WHERE "+"flight_name LIKE '%"+searchtextflight+"%' ";
        con.displayData(searchqueryflight, jTable1);
    }//GEN-LAST:event_textsearchflightKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(flighttable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new flighttable().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField textsearchflight;
