...
public class transactiontable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(textsearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 440, 30));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        config con = new config();
       int gettransactionid = usertable2.getSelectedRow();
       if(gettransactionid==-1){
           return;
       }
       int uid2 = Integer.parseInt(usertable2.getValueAt(gettransactionid, 0).toString());
       String deleteuser = "DELETE FROM table_transactions WHERE transaction_id = ?";
       con.deleteRecord(deleteuser, uid2);
       String refreshusertable = "SELECT transaction_id,user_name,flight_name,flight_from,flight_to FROM table_transactions INNER JOIN table_users ON table_users.user_id = table_transactions.user_id INNER JOIN table_flights ON table_flights.flight_id = table_transactions.flight_id";
    ...
    private void textsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textsearchKeyReleased
        ...
        String searchquery = "SELECT transaction_id,user_name,flight_name,flight_from,flight_to FROM table_transactions INNER JOIN table_users ON table_users.user_id = table_transactions.user_id INNER JOIN table_flights ON table_flights.flight_id = table_transactions.flight_id WHERE "+"user_name LIKE '%"+searchtext+"%' ";
